...
; This start address can be changed, noting the BIOS/Monitor locations

      .ORG    $8000	             ; Start of Basic in ROM
...
;
      .word KBDin           	; byte in from C02BIOS (no waiting)
      .word SCRNout           	; byte out from C02BIOS
      .word SBCload           	; null load JMP for EhBASIC
      .word SBCsave           	; null save JMP for EhBASIC
      .word LAB_dowarm             ; Warm start JMP for C02 Monitor
